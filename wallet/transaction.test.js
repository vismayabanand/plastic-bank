...
describe('Transaction()',() => {
    ...
    describe('outputMap', () => {
        ...
        it('outsputs the remaining balance for the `senderWallet`', () => {
    ...
    describe('validTransaction()', () => {
        ...
        describe('when the transaction is invalid', () => {
            describe('The transaction outputMap is invalid', () => {
            ...
            describe('The transaction input signature is invalid', () => {
                it('returns false and logs an error', () => {
                    transaction.input.signature = new Wallet().sign('useless-data');
    ...
    describe('update()', () => {
        ...
        describe('and the amount is inavlid',() => {
            it('throws an error', () => {
                expect(() => {
                    transaction.update({
